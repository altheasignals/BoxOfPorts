...
show_completion() {
    ...
    echo ""
    echo "Shell completion (highly recommended):"
    echo "  boxofports --install-completion   - Enable TAB completion"
    echo "  # Restart your terminal after running the above command"
    echo "  # Then try: boxofports <TAB> or boxofports sms <TAB>"
    echo ""
    echo "Configuration:"

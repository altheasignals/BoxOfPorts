...
echo "   bop help-tree                     # Explore complete command structure"
echo "   bop config add-profile            # Create your first gateway profile"
echo ""
echo "🔧 Shell Completion (Recommended):"
echo "   bop --install-completion          # Enable TAB completion"
echo "   # Restart your terminal after running the above"
echo "   # Then try: bop <TAB> or bop sms <TAB>"
